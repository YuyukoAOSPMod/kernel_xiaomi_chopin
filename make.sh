...
make CC=$CLANG_PATH/bin/clang CLANG_TRIPLE=$CLANG_PATH/bin/aarch64-linux-gnu- CROSS_COMPILE=$CLANG_PATH/bin/aarch64-linux-gnu- O=$OUTPUT chopin_user_defconfig
